...
const AccessNew = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.message || "Erreur lors de la création de l'accès")
      console.error(error)
    } finally {
      setIsLoading(false)
    }
        ...
        <div className="form-card">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <select id="access_type" name="access_type" value={formData.access_type} onChange={handleChange} required>
